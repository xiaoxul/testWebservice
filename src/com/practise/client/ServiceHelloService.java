 ...
 * 
 */
@WebServiceClient(name = "ServiceHelloService", targetNamespace = "http://service.test.com/", wsdlLocation = "http://localhost:9098/service/ServiceHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEHELLOSERVICE_QNAME = new QName("http://service.test.com/", "ServiceHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9098/service/ServiceHello?wsdl");
    ...
    public ServiceHello getServiceHelloPort() {
        return super.getPort(new QName("http://service.test.com/", "ServiceHelloPort"), ServiceHello.class);
    }
    ...
    public ServiceHello getServiceHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.test.com/", "ServiceHelloPort"), ServiceHello.class, features);
    }
