 ...
 * generated in the com.practise.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValueResponse_QNAME = new QName("http://service.test.com/", "getValueResponse");
    private final static QName _GetValue_QNAME = new QName("http://service.test.com/", "getValue");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.practise.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.test.com/", name = "getValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.test.com/", name = "getValue")
